...
A = np.array(   [[2.22147,  0.05273,  0.00901],
                [0.05273,  2.24324, -0.00910],
                [0.00901, -0.00910,  2.24329]])
b = np.array([21.54,  -45.48,   67.95])


# Read raw data and apply calibration
rawData = np.genfromtxt('raw/raw_mag1.csv', delimiter=',')  # Read raw measurements
